...
const CACHE_KEY = "comunidade-naftali-acampa2-campistas-cache";
...
export function ComunidadeNaftaliCampistas() {
  ...
  const downloadExcel = () => {
    ...
    const fileName = `comunidade_naftali_campistas${new Date().toISOString().split('T')[0]}.xlsx`;
      ...
      <CardHeader className="bg-gradient-to-r from-indigo-50 to-purple-50 border-b px-6 py-5">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-slate-600">
            Acampa 2 - Inscrições Campistas 2025
          </p>
