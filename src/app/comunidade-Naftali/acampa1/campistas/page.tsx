// /app/comunidade-Naftali/page.tsx

import { ComunidadeNaftaliAcampa1Campistas } from "@/components/Comunidades/Naftali/Acampa 1 Campista";
...
export default async function comunidadeNaftali() {
      ...
      <SidebarInset>
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb>
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage>Comunidade Naftali</BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
            </Breadcrumb>
          </div>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          <div className="min-h-[100vh] flex-1 rounded-xl bg-muted/50 md:min-h-min">
            <ComunidadeNaftaliAcampa1Campistas />
          </div>
        </div>
      </SidebarInset>
    </SidebarProvider>
