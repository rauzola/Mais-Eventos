...
export function EventForm({
  ...
  const handleNumberChange = (field: keyof EventFormValues, val: string) => {
    ...
    setValues((prev) => ({
      ...prev,
      [field]: isNaN(Number(num)) ? null : (num as unknown as number | null),
    }));
  };
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("event_date_start", e.target.value)
                }
                className="w-full"
              />
            </div>
            ...
            <div>
              <label className="block text-sm font-medium mb-2">
                Texto para Confirmar Inscrição
              </label>
              <Textarea
                rows={4}
                value={values.confirmation_text ?? ""}
                onChange={(e) =>
                  handleChange("confirmation_text", e.target.value)
                }
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={(v) => handleChange("participant_type", v)}
              >
            ...
            <div className="border-t pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="Ex: Casa de Retiros São José, Maringá"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2">
              ...
              <div className="mt-4">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleChange("organizer_contact", e.target.value)
                  }
                  placeholder="Ex: (44) 99999-9999 ou email@exemplo.com"
                />
              </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    value={
                      ...
                      values.max_participants === undefined
                        ? ""
                        : String(values.max_participants)
                    }
                    onChange={(e) =>
                      handleNumberChange("max_participants", e.target.value)
                    }
                    placeholder="Ex: 50"
                  />
                </div>
              ...
              <div className="mt-4">
                ...
                <Textarea
                  ...
                  placeholder="Como realizar o pagamento, dados bancários, etc..."
                />
              </div>
              ...
              <div className="mt-4">
                ...
                <Textarea
                  ...
                  placeholder="Condições para cancelamento e reembolso..."
                />
              </div>
              ...
              <div className="mt-4">
                ...
                <Textarea
                  rows={4}
                  value={(values.required_items ?? []).join("\n")}
                  onChange={(e) =>
                    setValues((prev) => ({
                      ...prev,
              ...
              <div className="mt-4">
                ...
                <Textarea
                  ...
                  placeholder="Como chegar ao local, transporte disponível, etc..."
                />
              </div>
              ...
              <div className="flex items-center gap-6 mt-4 pt-4 border-t">
                <label className="flex items-center gap-2 text-sm">
                  <input
                    type="checkbox"
                    checked={Boolean(values.meals_included)}
                    onChange={(e) =>
                      handleBoolChange("meals_included", e.target.checked)
                    }
                  />
                ...
                <label className="flex items-center gap-2 text-sm">
                  <input
                    type="checkbox"
                    checked={Boolean(values.accommodation_included)}
                    onChange={(e) =>
                      handleBoolChange(
